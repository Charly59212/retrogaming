...
<main>
    <div class="container">
        <div class="card border shadow-sm rounded-3 px-2 py-2">
            <h1 class="text-center rounded-3 bg-secondary text-white py-2 mx-auto w-100">L'univers des consoles portables</h1>
                    ...
                    <div class="comment">
                        ...
                        <?php if (isset($_SESSION['name']) && $_SESSION['name'] == $comment['user_name']): ?>
                            <form action="<?php echo BASE_URL; ?>public/index.php?action=deleteComment" method="POST">
                                ...
                                <input type="hidden" name="action" value="viewPocketArticle">
                                <div class="text-end">
